...
| **terraform-aws-docker** (this repo) | [`hansohn/terraform-aws`](https://hub.docker.com/r/hansohn/terraform-aws) | Base image plus the AWS CLI and the TFLint AWS ruleset |
